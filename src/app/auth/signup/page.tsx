          ...
          >
            <Card className="shadow-2xl p-8 text-center">
              <CardContent>
                ...
                <div className="bg-mission-primary/10 border border-mission-primary/30 text-mission-primary px-4 py-3 rounded mb-4">
                  <p className="text-sm">You will be automatically redirected to the sign-in page in a few seconds...</p>
                </div>
